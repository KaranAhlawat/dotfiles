...
(defun korv/set-font-faces ()
  ...
  (set-face-attribute 'default nil :font korv/font-name :height korv/default-font-size :weight 'normal)
  (set-face-attribute 'fixed-pitch nil :font korv/font-name :height korv/default-font-size :weight 'normal)
  (set-face-attribute 'variable-pitch nil :font korv/font-name :height korv/default-variable-font-size))
...
(use-package vscode-dark-plus-theme
  ...
  (setq vscode-dark-plus-box-org-todo t))
